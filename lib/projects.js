const tech = {
  ...
  reactjs: 'React.js - user interface library',
  nextjs: 'Next.js - React framework for production',
  vue: 'Vue.js - JavaScript framework for building UIs',
  nuxt: 'Nuxt.js - Vue framework',
  mongodbatlas: 'MongoDB Atlas - Cloud database and data services',
  swr: 'SWR - React hooks for data fetching',
  vercel: 'Vercel - platform for deploying and hosting',
  nodejs: 'Node.js - back-end JavaScript runtime environment',
  express: 'Express.js - back end web application framework for Node.js',
  ...
  knexjs: 'Knex.js - SQL query builder for JavaScript',
...
export const projects = [
  {
    ...
    bullets: [
      ...
      'Since the base 64 string is too long, an API service is provided to stores a short, unique id that can be used in a shorter, shareable URL.',
