const tech = {
  ...
  restfulapis: 'RESTful APIs - application programming interface that conforms to the constraints of REST',
...
export const projects = [
  ...
  { name: 'ArchitectNFT',
    ...
    description: 'This is a Web3 App that lets users connect their Ethereum wallet and mint an NFT to their wallet. The NFT is a random three word statement using the last name of famous architects.',
    bullets: [ 
