const tech = {
  ...
  heroku: 'Heroku - platform for PostgreSQL database hosting',
  ...
  planetscale: 'PlanetScale - open source database platform',
  mui: 'Material UI - React component library',
  gpt3: 'GPT-3 - autoregressive language model',
  stripe: 'Stripe.js - Stripe’s browser-side JavaScript library',
  framer: 'Framer Motion - React motion libary',
  react3fiber: 'React Three Fiber - React renderer for three.js',
}
...
export const projects = [
  {
    ...
    github: null,
    description:
      'This full-stack app sells tokens that allow real estate agent users generate descriptions for their listings using GPT-3.',
    bullets: [
  ...
  },
  {
    ...
    github: null,
    description:
      'This full-stack app is a SaaS product the helps real estate investors quickly calculate their return on investment for residential income properties.',
    bullets: [
      'Leveraged Supabase for the backend to manage tables in the database, authentication, and creates API endpoints.',
      'Bootstrapped the React codebase using DivJoy codebase generator to build the foundation of the app.',
