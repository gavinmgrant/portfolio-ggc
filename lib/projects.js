...
export const projects = [
  ...
  },
  {
    ...
    bullets: [
      ...
      'Built re-usable, self-contained components for the home modules to create each home design.',
  ...
  },
  {
    ...
    technologies: [
      ...
      tech.bulma.description,
      tech.stripe.description,
      tech.postgresql.description,
      tech.supabase.description,
      tech.vercel.description,
    ],
  },
  {
    name: 'OmitPlastic',
    ...
    bullets: [
      'Connected Prisma to a MySQL database of product data hosted in the cloud by PlanetScale.',
