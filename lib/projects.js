...
export const projects = [
  ...
  },
  {
    ...
    github: null,
    description:
      'A website developed for Seattle-based general contractor Cadre General Contractors to showcase their work and services.',
    bullets: [
  ...
  },
  {
    ...
    description:
      'An urban geography quiz app that tests your knowledge of cities across the globe.',
    bullets: [
  ...
  },
  {
    ...
    description:
      'An app that recommends food and cocktail recipes for users planning a happy hour.',
    bullets: [
